...
public class MediaMetadataRetrieverDemo extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			if (path == "") {
				// 告诉用户提供音频文件URL。
				Toast.makeText(MediaMetadataRetrieverDemo.this, "请编辑MediaMetadataRetrieverDemo Activity, " + "and set the path variable to your audio file path." + "您的音频文件必须存储在SD卡上。", Toast.LENGTH_LONG).show();
				return;
			}
